...
public class ShiroCasConfiguration {
    ...
    // cas server地址
    public static final String casServerUrlPrefix = "http://127.0.0.1:8080";
    // Cas登录页面地址
    public static final String casLoginUrl = casServerUrlPrefix + "/login";
    // Cas登出页面地址
    public static final String casLogoutUrl = casServerUrlPrefix + "/logout";
    // 当前工程对外提供的服务地址
    public static final String shiroServerUrlPrefix = "http://127.0.0.1:8080/shiro";
...
//         filters.put("logout",logoutFilter());
    ...
    private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean){
        ...
        filterChainDefinitionMap.put("/shiro/**", "casFilter");
...
//        filterChainDefinitionMap.put("/shiro", "authc"); //需要登录
